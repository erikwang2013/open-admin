...
- **शील्ड-आकार का शरीर** — 18-परत गहन सुरक्षा के अनुरूप; शीर्ष एंटेना हमेशा जलता रहता है, जो सेवा के मेमोरी में स्थायी रूप से बने रहने (webman/workerman) को दर्शाता है
- **फ़ेस स्क्रीन की दो आँखें** — समय-समय पर पलक झपकती हैं; यह हर रिक्वेस्ट पर और मिडलवेयर चेन पर भी नज़र रखती हैं
- **छाती पर सत्यापन बैज** — सही का निशान हमेशा जलता रहता है, जो `method.path` अनुमति सत्यापन पास होने को दर्शाता है
...
**खुद बनाना है?** आइकन मानक: मुख्य रंग `#1677FF`, गर्म एंटेना `#FA8C16`, सत्यापन हरा `#52C41A`; कैनवास `240 × 320`, शील्ड केंद्र में, न्यूनतम उपयोगी आकार 48 px।
...
| 🏥 संचालन | स्वास्थ्य जाँच/metrics/API दस्तावेज़/security.txt | Prometheus + OpenAPI 3.0 + erikwang2013/apidoc-php इंटरैक्टिव दस्तावेज़ |
...
│   ├── api/
│   │   └── v1/controller/          # API v1 कंट्रोलर (संस्करण URL प्रीफ़िक्स /api/v1 में व्यक्त)
...
│   │   ├── lib/app/
│   │   │   ├── pages/          # 6 पूर्ण पेज (डैशबोर्ड/उपयोगकर्ता/भूमिका/कॉन्फ़िग/लॉग/प्रोफ़ाइल)
...
│   │   │   └── theme/          # Material 3 दोहरी थीम
│   │   └── web/index.html      # Web एंट्री (शीर्षक/विवरण/साइट आइकन)
...
├── database/                   # डेटाबेस स्क्रिप्ट
│   ├── install.sql             # पूर्ण इंस्टॉल स्क्रिप्ट (अनुमति सीड डेटा सहित)
│   └── backup/                 # बैकअप और रिस्टोर स्क्रिप्ट
├── docs/                       # दस्तावेज़
│   ├── ARCHITECTURE.md         # आर्किटेक्चर डिज़ाइन आरेख (Mermaid)
│   ├── DESIGN.md               # डिज़ाइन दस्तावेज़
│   ├── SECURITY.md             # सुरक्षा आर्किटेक्चर डिज़ाइन
│   ├── API.md                  # API संदर्भ दस्तावेज़
│   ├── diagrams/               # चित्र निर्देशिका
│   │   ├── architecture.svg    # सिस्टम आर्किटेक्चर डिज़ाइन चित्र (SVG)
│   │   ├── features.svg        # फ़ीचर डिज़ाइन चित्र (SVG)
│   │   ├── lifecycle.svg       # लाइफसाइकल चित्र (SVG)
│   │   └── 01..12-*.md         # विघटित चित्र (Mermaid, 12 भाषाओं के अनुवाद)
│   └── translations/           # बहुभाषी दस्तावेज़ (12 भाषाएँ × README/CLAUDE)
├── public/                     # सार्वजनिक एंट्री (Web रूट)
│   ├── img/pet.svg             # प्रोजेक्ट पेट「शियाओ आन」(SVG, साइट आइकन भी)
│   └── favicon.ico             # पुराने ब्राउज़रों के लिए .ico फ़ॉलबैक
├── resource/translations/      # रनटाइम भाषा पैक (zh_CN / en)
├── tests/                      # PHPUnit टेस्ट
├── runtime/                    # रनटाइम फ़ाइलें
└── vendor/                     # Composer निर्भरताएँ
```

## आर्किटेक्चर डिज़ाइन और चित्र

तीनों चित्र **पूर्णतः हस्तलिखित SVG** हैं（कोई स्क्रिप्ट नहीं, कोई बाहरी फ़ॉन्ट निर्भरता नहीं, असीम रूप से स्केलेबल）, इन्हें GitHub / ब्राउज़र में सीधे देखा जा सकता है और PPT तथा दस्तावेज़ों में भी डाला जा सकता है:
...
- **API संस्करण**: संस्करण संख्या URL प्रीफ़िक्स में व्यक्त होती है (जैसे `/api/v1/...`), रिक्वेस्ट हेडर का उपयोग नहीं होता
