...
ওপেন অ্যাডমিন (open-admin) webman v2-ভিত্তিক, RESTful JSON API প্রদান করে। সব অ্যাডমিন এন্ডপয়েন্টে JWT অথেনটিকেশন ও RBAC পারমিশন ভেরিফিকেশন প্রয়োজন, পাবলিক এন্ডপয়েন্টগুলো URL প্রিফিক্সে ভার্সন বহন করে (যেমন `/api/v1/auth/login`) এবং সরাসরি সংশ্লিষ্ট ভার্সনের কন্ট্রোলারে রাউট হয়।

- **বেস URL**: `http://localhost:8787`
- **API ভার্সন**: URL প্রিফিক্সে নিহিত (`/api/v1/...`、`/api/v2/...`); কোনো রিকোয়েস্ট হেডার ব্যবহার করা হয় না
...
> **এন্ডপয়েন্ট ওভারভিউ**: অথেনটিকেশন(4) | ড্যাশবোর্ড(1) | ইউজার(7) | রোল(4) | পারমিশন(4) | কনফিগ(4) | লগ(1) | প্রোফাইল(3) | ইমপোর্ট-এক্সপোর্ট(3) | আপলোড(1) | অপারেশন(4: health/metrics/docs/security.txt) | মোট ৩৭টি এন্ডপয়েন্ট
...
সব পাবলিক এন্ডপয়েন্ট `/api/{version}` রাউট গ্রুপে মাউন্ট করা (যেমন `app\api\v1\controller\AuthController`), ভার্সন ডিসপ্যাচ কোনো মিডলওয়্যার ছাড়াই স্ট্যাটিক রাউট গ্রুপ দিয়ে হয়।
...
| ফিল্ড | টাইপ | আবশ্যক | বর্ণনা |
|------|------|------|------|
| refresh_token | string | হ্যাঁ | লগইনে পাওয়া refresh_token |
...
### 3.7 Prometheus মনিটরিং মেট্রিক
