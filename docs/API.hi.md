...
open-admin (ओपन एडमिन पैनल) webman v2 पर आधारित है और RESTful JSON API प्रदान करता है। सभी एडमिन साइड इंटरफ़ेस के लिए JWT प्रमाणीकरण और RBAC अनुमति सत्यापन आवश्यक है; सार्वजनिक इंटरफ़ेस का संस्करण नंबर URL प्रीफ़िक्स में व्यक्त होता है (जैसे `/api/v1/auth/login`), और सीधे संबंधित संस्करण-नियंत्रित कंट्रोलर में रूट होता है।

- **बेस URL**: `http://localhost:8787`
- **API संस्करण**: संस्करण संख्या URL प्रीफ़िक्स में व्यक्त होती है（`/api/v1/...`、`/api/v2/...`）, रिक्वेस्ट हेडर का उपयोग नहीं होता
...
> **एंडपॉइंट अवलोकन**: प्रमाणीकरण(4) | डैशबोर्ड(1) | उपयोगकर्ता(7) | भूमिका(4) | अनुमति(4) | कॉन्फ़िग(4) | लॉग(1) | प्रोफ़ाइल केंद्र(3) | आयात-निर्यात(3) | अपलोड(1) | संचालन(4: health/metrics/docs/security.txt) | कुल 36 एंडपॉइंट
...
| फ़ील्ड | प्रकार | अनिवार्य | विवरण |
|------|------|------|------|
| refresh_token | string | हाँ | लॉगिन के समय प्राप्त refresh_token |
...
### 3.7 Prometheus मॉनिटरिंग मेट्रिक्स
