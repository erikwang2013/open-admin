...
sequenceDiagram
    ...
    Note over U,CAP: Passo 2: Clique do usuário
    CL->>CL: Renderiza a imagem, mostra "Clique em: árvore→pássaro→flor"
    U->>CL: Clique sequencial nas posições das palavras na imagem
    CL->>CL: Coleta clicks:[{x,y},{x,y},{x,y}]
    end

    rect rgb(255, 240, 230)
    Note over U,CAP: Passo 3: Verificação do login
    ...
    Note over U,CL: Passo 4: Requisições subsequentes
